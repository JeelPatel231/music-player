...
class SCHomeFeedClient(
    ...
    private val linkHandler = SoundcloudChartsLinkHandlerFactory().fromId("top")// TODO: probably wrong
    private val feedExtractor by lazy { SoundcloudChartsExtractor(SoundCloud, linkHandler, "top") }
